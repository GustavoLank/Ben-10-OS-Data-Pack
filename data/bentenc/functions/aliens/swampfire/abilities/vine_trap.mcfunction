...
execute anchored eyes run summon minecraft:armor_stand ^ ^ ^1 {Tags:["glcore.src","glcore.src.noEntityCollision","bentenc.src.vine_trap.swampfire"],CustomName:'{"text":"(Swampfire) Vine Trap"}',Silent:1b,Small:1b,Invisible:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:80000}}]}
