...
execute unless data entity @s Inventory[{Slot:-106b}].tag.bentenc.select_playlist[0].skin store result score @s bentenc.skin run data get entity @s Inventory[{Slot:-106b}].tag.bentenc.omnitrix
execute if data entity @s Inventory[{Slot:-106b}].tag.bentenc.select_playlist[0].skin store result score @s bentenc.skin run data get entity @s Inventory[{Slot:-106b}].tag.bentenc.select_playlist[0].skin
execute if data entity @s Inventory[{Slot:-106b}].tag.bentenc.select_playlist[0].alien.random run function bentenc:omnitrix_core/random/start
execute if data entity @s Inventory[{Slot:-106b}].tag.bentenc.select_playlist[0].alien_fusion.random run function bentenc:omnitrix_core/randomf/start
