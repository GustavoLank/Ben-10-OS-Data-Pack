summon minecraft:marker ~ ~ ~ {Tags:["glcore.src","glcore.src.set_ice","bentenc.src.eye_guy.freeze_ray"],CustomName:'{"text":"(Eye Guy) Freeze Ray"}'}
scoreboard players set #srcVel glcore 4
scoreboard players set #srcMax glcore 30
scoreboard players set #srcDamage glcore 10
scoreboard players set #srcFreeze glcore 30
