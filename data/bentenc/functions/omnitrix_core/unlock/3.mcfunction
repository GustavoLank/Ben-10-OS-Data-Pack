...
data modify storage gl:bentenc unlockAliens append from storage gl:bentenc unlock.unlockables[0].aliens[2]
...
execute if score #temp glcore matches 1 if data storage gl:bentenc unlock.unlockables[0] run function bentenc:omnitrix_core/unlock/3