...
summon minecraft:marker ~ ~ ~ {Tags:["glcore.src","bentenc.src.slime_projectiles"],CustomName:'{"text":"Slime Projectile"}'}
...
playsound minecraft:entity.slime.squish ambient @a[distance=..5] ~ ~ ~ 1 1.6 1