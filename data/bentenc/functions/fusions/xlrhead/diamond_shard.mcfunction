...
execute anchored eyes run summon minecraft:armor_stand ^ ^ ^1 {Tags:["glcore.src"],CustomName:'{"text":"Diamond Shard"}',Silent:1b,Small:1b,Invisible:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:knowledge_book",Count:1b,tag:{CustomModelData:380019}}]}
