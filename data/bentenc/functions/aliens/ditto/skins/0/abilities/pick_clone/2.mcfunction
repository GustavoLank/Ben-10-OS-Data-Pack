...
summon armor_stand ~ ~ ~ {Tags:["bentenc.ditto.clone.picked"],Invisible:1b,Invulnerable:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:knowledge_book",Count:1b,tag:{CustomModelData:80059}}]}
